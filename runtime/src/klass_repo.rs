...
impl SharedKlassRepo {
    ...
    fn run_clinit_method(
        &mut self,
        klass_name: &String,
        i_callback: fn(&mut SharedKlassRepo, &OtMethod, &mut InterpLocalVars) -> Option<JvmValue>,
    ) {
    ...
    pub fn bootstrap(
        ...
        self.install_native_method(
            &"java/lang/Object".to_string(),
            &"notify:()V".to_string(),
            crate::native_methods::java_lang_Object__notify,
        );
        self.install_native_method(
            &"java/lang/Object".to_string(),
            &"notifyAll:()V".to_string(),
            crate::native_methods::java_lang_Object__notifyAll,
        );
        self.install_native_method(
            &"java/lang/Object".to_string(),
            &"wait:(J)V".to_string(),
            crate::native_methods::java_lang_Object__wait,
        );
        ...
        self.install_native_method(
            ...
            crate::native_methods::java_lang_Class__getName,
        );
        ...
        self.install_native_method(
            ...
            crate::native_methods::java_lang_Compiler__compileClass,
        );
        self.install_native_method(
            &"java/lang/Compiler".to_string(),
            &"compileClasses:(Ljava/lang/String;)Z".to_string(),
            crate::native_methods::java_lang_Compiler__compileClasses,
        );
        //        public static final native java.lang.Object command(java.lang.Object);
        self.install_native_method(
            &"java/lang/Compiler".to_string(),
            &"enable:()V".to_string(),
            crate::native_methods::java_lang_Compiler__enable,
        );
        self.install_native_method(
            &"java/lang/Compiler".to_string(),
            &"disable:()V".to_string(),
            crate::native_methods::java_lang_Compiler__disable,
        );

        self.install_native_method(
            &"java/lang/Runtime".to_string(),
            &"freeMemory:()J".to_string(),
            crate::native_methods::java_lang_Runtime__freeMemory,
        );
        self.install_native_method(
            &"java/lang/Runtime".to_string(),
            &"totalMemory:()J".to_string(),
            crate::native_methods::java_lang_Runtime__totalMemory,
        );
        self.install_native_method(
            &"java/lang/Runtime".to_string(),
            &"gc:()V".to_string(),
            crate::native_methods::java_lang_Runtime__gc,
        );
        self.install_native_method(
            &"java/lang/Runtime".to_string(),
            &"runFinalization:()V".to_string(),
            crate::native_methods::java_lang_Runtime__runFinalization,
        );
        self.install_native_method(
            &"java/lang/Runtime".to_string(),
            &"traceInstructions:(Z)V".to_string(),
            crate::native_methods::java_lang_Runtime__traceInstructions,
        );
        self.install_native_method(
            &"java/lang/Runtime".to_string(),
            &"traceMethodCalls:(Z)V".to_string(),
            crate::native_methods::java_lang_Runtime__traceMethodCalls,
        );
        ...
        self.install_native_method(
            ...
            crate::native_methods::java_lang_System__arraycopy,
        );
        ...
        self.install_native_method(
            ...
            &"sin:(D)D".to_string(),
            crate::native_methods::java_lang_Math__sin,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"cos:(D)D".to_string(),
            crate::native_methods::java_lang_Math__cos,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"tan:(D)D".to_string(),
            crate::native_methods::java_lang_Math__tan,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"asin:(D)D".to_string(),
            crate::native_methods::java_lang_Math__asin,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"acos:(D)D".to_string(),
            crate::native_methods::java_lang_Math__acos,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"atan:(D)D".to_string(),
            crate::native_methods::java_lang_Math__atan,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"exp:(D)D".to_string(),
            crate::native_methods::java_lang_Math__exp,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"log:(D)D".to_string(),
            crate::native_methods::java_lang_Math__log,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"sqrt:(D)D".to_string(),
            crate::native_methods::java_lang_Math__sqrt,
        );
        //public static final native double IEEEremainder(double, double);
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"ceil:(D)D".to_string(),
            crate::native_methods::java_lang_Math__ceil,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"floor:(D)D".to_string(),
            crate::native_methods::java_lang_Math__floor,
        );
        //public static final native double rint(double);
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"atan2:(DD)D".to_string(),
            crate::native_methods::java_lang_Math__atan2,
        );
        self.install_native_method(
            &"java/lang/Math".to_string(),
            &"pow:(DD)D".to_string(),
            crate::native_methods::java_lang_Math__pow,
        );
        ...
        self.install_native_method(
            ...
            crate::native_methods::java_io_FileDescriptor__initSystemFD,
        );
    ...
    pub fn lookup_method_exact(&self, klass_name: &String, fq_name_desc: String) -> OtMethod {
        match self.klass_lookup.get(klass_name) {
            Some(cell) => match &*(cell.borrow()) {
                KlassLoadingStatus::Mentioned {} => {
                    panic!("Klass with ID {} is not loaded yet", klass_name)
                }
                KlassLoadingStatus::Loaded { klass: k } => k
                    .get_method_by_name_and_desc(&fq_name_desc)
                    .unwrap()
                    .clone(),
                KlassLoadingStatus::Live { klass: k } => k
                    .get_method_by_name_and_desc(&fq_name_desc)
                    .unwrap()
                    .clone(),
            },
