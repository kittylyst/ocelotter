...
impl InterpEvalStack {
    ...
    pub fn lcmp(&mut self) {
        let v2 = self
            .pop()
            .as_long()
            .expect("Non-long seen on stack during LCMP");
        let v1 = self
            .pop()
            .as_long()
            .expect("Non-long seen on stack during LCMP");
    ...
    pub fn f2d(&mut self) {
        let i1 = self
            .pop()
            .as_float()
            .expect("Unexpected, non-float value encountered");
        self.push(JvmValue::Double(i1 as f64));
    }
    ...
    pub fn fcmpg(&mut self) {
        let v2 = self
            .pop()
            .as_float()
            .expect("Non-float seen on stack during FCMPG");
        let v1 = self
            .pop()
            .as_float()
            .expect("Non-float seen on stack during FCMPG");
        self.push(
            f32::partial_cmp(&v1, &v2)
                .map(ordering)
                .unwrap_or(JvmValue::Int(1)),
        );
    }
    ...
    pub fn fcmpl(&mut self) {
        let v2 = self
            .pop()
            .as_float()
            .expect("Non-float seen on stack during FCMPL");
        let v1 = self
            .pop()
            .as_float()
            .expect("Non-float seen on stack during FCMPL");
    ...
    pub fn dadd(&mut self) {
        ...
        let i1 = self
            .pop()
            .as_double()
            .expect("Unexpected, non-double value encountered");
        let i2 = self
            .pop()
            .as_double()
            .expect("Unexpected, non-double value encountered");
    ...
    pub fn dcmpg(&mut self) {
        let v2 = self
            .pop()
            .as_double()
            .expect("Non-double seen on stack during DCMPG");
        let v1 = self
            .pop()
            .as_double()
            .expect("Non-double seen on stack during DCMPG");
        self.push(
            f64::partial_cmp(&v1, &v2)
                .map(ordering)
                .unwrap_or(JvmValue::Int(1)),
        )
    }
    ...
    pub fn dcmpl(&mut self) {
        let v2 = self
            .pop()
            .as_double()
            .expect("Non-double seen on stack during DCMPL");
        let v1 = self
            .pop()
            .as_double()
            .expect("Non-double seen on stack during DCMPL");
